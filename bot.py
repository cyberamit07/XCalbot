...
# Custom emoji IDs with fallback
EMOJIS = {
...
def escape_html(text: str) -> str:
    ...
    return htmlescape(str(text))

def format_result(expression: str, result: str) -> str:
    """Format calculator result with premium styling"""
    calc_emoji = format_emoji(EMOJIS['calculator'][0], EMOJIS['calculator'][1])
    premium_emoji = format_emoji(EMOJIS['premium'][0], EMOJIS['premium'][1])
    success_emoji = format_emoji(EMOJIS['success'][0], EMOJIS['success'][1])
    sparkle_emoji = format_emoji(EMOJIS['sparkle'][0], EMOJIS['sparkle'][1])
...
def format_error(error_msg: str) -> str:
    ...
    error_emoji = format_emoji(EMOJIS['error'][0], EMOJIS['error'][1])
...
async def start_command(message: Message) -> None:
    ...
    calc_emoji = format_emoji(EMOJIS['calculator'][0], EMOJIS['calculator'][1])
    sparkle_emoji = format_emoji(EMOJIS['sparkle'][0], EMOJIS['sparkle'][1])
    info_emoji = format_emoji(EMOJIS['info'][0], EMOJIS['info'][1])
...
async def show_admin_panel(message: Message) -> None:
    """Show admin panel"""
    admin_emoji = format_emoji(EMOJIS['admin'][0], EMOJIS['admin'][1])
    stats_emoji = format_emoji(EMOJIS['stats'][0], EMOJIS['stats'][1])
    broadcast_emoji = format_emoji(EMOJIS['broadcast'][0], EMOJIS['broadcast'][1])
    users_emoji = format_emoji(EMOJIS['users'][0], EMOJIS['users'][1])
    refresh_emoji = format_emoji(EMOJIS['sparkle'][0], EMOJIS['sparkle'][1])
...
async def show_stats(message: Message) -> None:
    ...
    stats_emoji = format_emoji(EMOJIS['stats'][0], EMOJIS['stats'][1])
    users_emoji = format_emoji(EMOJIS['users'][0], EMOJIS['users'][1])
    fire_emoji = format_emoji(EMOJIS['fire'][0], EMOJIS['fire'][1])
    growth_emoji = format_emoji(EMOJIS['growth'][0], EMOJIS['growth'][1])
